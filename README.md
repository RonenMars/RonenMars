...
| **[groceries-bot](https://github.com/RonenMars/groceries-bot)** | Telegram-controlled shared groceries list with a Next.js web UI, one service layer driving both |
| **[yad2-scanner](https://github.com/RonenMars/yad2-scanner)** | Headless rental-listing scanner with Telegram + Gmail alerts, Neon Postgres, and per-user schedules |
